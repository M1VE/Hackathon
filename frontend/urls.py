...
urlpatterns = [
    ...
    path(
        "hackathons/",
        views.hackathon_list,
        name="hackathon_list"
    ),
    path(
        "hackathons/<int:pk>/",
        views.hackathon_detail,
        name="hackathon_detail"
    ),
    path(
        "hackathons/<int:pk>/join/",
        views.join_hackathon,
        name="join_hackathon"
    ),

    # Команды
    path(
        "hackathons/<int:pk>/create-team/",
        views.create_team,
        name="create_team"
    ),
    path(
